...
subTitle.innerHTML = ('As impossible as it seems to name just 1 of the 208 legendary episodes as the “best”, the fans have spoken and the highest rated episode is… wait for it…');
main.appendChild(subTitle);

const episodeTitle = document.createElement('h2');
episodeTitle.innerHTML = ('The Slap Bet (Season 2, Episode 9)');
main.appendChild(episodeTitle);
